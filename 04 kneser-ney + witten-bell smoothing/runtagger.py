...
def predict(emissions, transitions, test):
    """
    Tags list of sentences with most likely POS based on emissions and transitions probabilities
            ...
            if j==0:
                for tag1 in tag_types:
                    ...
                    if word in emissions[tag1].keys():
                        ...
                        M[j][tag1]['prob'] = emissions[tag1]["<UNK>"] * transitions["<s>"][tag1]
                        pass
            ...
            # if rest of sentence
                ...
                for tag1 in tag_types:
                    ...
                    if word in emissions[tag1].keys():
                        ...
                        M[j][tag1]['prob'] = step_probs[best_prev] * emissions[tag1]["<UNK>"]
                        pass
...
def tag_sentence(test_file, model_file, out_file):
    """
    Main function to tag sentences
    ...
    ##### predict #####
    final_output = predict(emissions, transitions, test)
